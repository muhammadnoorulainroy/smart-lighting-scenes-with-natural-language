  ...
  >
    ...
    >
      ...
      >
        <div 
          v-if="show"
          class="card p-8 max-w-md w-full relative animate-slide-up"
        >
          <!-- Close button -->
          <button 
            @click="$emit('close')"
          ...
          <div class="flex justify-center mb-4">
            <div class="w-16 h-16 bg-gradient-to-br from-primary-400 to-accent-500 rounded-full flex items-center justify-center">
          ...
          <!-- Title -->
          <h2 class="text-2xl font-display font-bold text-center mb-2 text-neutral-900 dark:text-neutral-100">
