 ...
 *
 * <p>Encapsulates the full lifecycle of a natural language command:</p>
 * <ul>
 *   <li>Input text from user</li>
 *   <li>Parsed command structure from LLM</li>
 *   <li>Execution result and status</li>
 *   <li>Schedule and conflict information</li>
 * </ul>
 *
